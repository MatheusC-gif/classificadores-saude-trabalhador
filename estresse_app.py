...
# O Streamlit Cloud pode manter módulos importados em memória entre atualizações.
app_module = importlib.reload(app_module)
_mostrar_estresse = app_module._mostrar_estresse
_mostrar_ipaq = app_module._mostrar_ipaq
calcular_estresse = app_module.calcular_estresse
relatorio_estresse = app_module.relatorio_estresse
relatorio_estresse_pdf = app_module.relatorio_estresse_pdf
